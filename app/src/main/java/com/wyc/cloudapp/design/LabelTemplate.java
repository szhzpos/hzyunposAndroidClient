...
public class LabelTemplate implements Parcelable {
     ...
     * */
    @NonNull
    Integer realWidth = width2Pixel(this, CustomApplication.self());
    @NonNull
    Integer realHeight = height2Pixel(this,CustomApplication.self());
    @NonNull
    String itemList = "[]";
    ...
    public List<ItemBase> printSingleGoodsById(String barcodeId){
        generatePrinterDataItem(barcodeId);
        return printItem;
    }

    public void generatePrinterDataItem(String barcodeId){
        final DataItem.LabelGoods goods = DataItem.getGoodsDataById(barcodeId);
        if (goods != null){
    ...
    public static List<LabelTemplate.LabelSize> getDefaultSize(){
        final List<LabelTemplate.LabelSize> list = new ArrayList<>();
        list.add(new LabelTemplate.LabelSize(70,40));
        list.add(new LabelTemplate.LabelSize(50,40));
        list.add(new LabelTemplate.LabelSize(30,20));
        return list;
    }
