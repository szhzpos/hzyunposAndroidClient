...
public final class RefundDialogAdapter extends RecyclerView.Adapter<RefundDialogAdapter.MyViewHolder>  {
    ...
    public void setDatas(final String order_code,final StringBuilder err){
        ...
        final JSONObject retJson = httpRequest.sendPost(mContext.getUrl() + "/api/refund/getretailrefund",HttpRequest.generate_request_parma(object,mContext.getAppSecret()),true);
