    ...
    public static class MobileAddWholesaleSellOrderActivity extends MobileWholesaleBaseActivity {
        ...
        protected void querySourceOrderInfo(final String id){
            ...
            CustomApplication.execute(()->{
                final JSONObject retJson = HttpUtils.sendPost(getUrl() + "/api/pfdhd/xinfo", HttpRequest.generate_request_parm(parameterObj,getAppSecret()),true);
        ...
        protected Intent launchSourceActivity() {
            ...
            intent.putExtra(AbstractMobileActivity.TITLE_KEY,getString(R.string.select_anything_hint,getString(R.string.wholesale_order_sz)));
            return intent;
        }
    }
}
